...
public class DxyPatchUtil {

    public final static String PATCH_PATH = Environment.getExternalStorageDirectory().getPath()
            + File.separator
            + "Download"
            + File.separator
            + "dxy"
    ...
    public static void copyJarToFileFromAssets(Activity activity) {
        try {
